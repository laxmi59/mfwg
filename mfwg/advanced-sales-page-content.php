...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	if($res[0]==1)
	{
		echo "<script>location.replace('advanced-sales-page-testimonials.php')</script>";
		//Header("Location: advaced-sales-page-testimonials.php");
		exit;
	}
}
...
<div class="site-image" id="site-image">
  <div class="hfeed" id="page">
    <div id="main">
	<form method="post" onSubmit="return AdvancedSalesPageContentValidation(this)" enctype="multipart/form-data">
      <div id="primary" class="pd30">
        <div class="blue-grd blue-bdr tabs">
          ...
          <ul class="threecol">
            ...
            <li class="active "><span class="edit-icon"></span> <a href="advanced-sales-page-content.php"> Content </a></li>
            <li class="last"><a href="advanced-sales-page-testimonials.php"> Testimonials </a></li>
          </ul>
        </div>
        <div class="blue-grd blue-bdr msgbox mt20 mb10">
          <div class="tooltip-arrow"></div>
          <div class="blue-corner topLeft"></div>
          <div class="blue-corner topRight"></div>
          <div class="blue-corner bottomLeft"></div>
          <div class="blue-corner bottomRight"></div> 
         This page allows you to provide content for your website, including a headline, sub headline, “about” section, body section, and up to 3 images. 
and up to 3 images.</div> 
        ...
        <div><input type="button" name="content_submit_back" value="" class="prevbtn mt20 ml20 f-left"  onClick="javascript:window.location='advanced-sales-page-design.php'"></div>
