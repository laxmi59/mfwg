...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	if($res[0]==1)
	{
		echo "<script>location.replace('sales-page-content.php')</script>";
		exit;
	}
}
	...
	<form method="post" onSubmit="return salesPageDesignValidation(this)" enctype="multipart/form-data">
      <div id="primary" class="pd30">
        <div class="blue-grd blue-bdr tabs">
          ...
          <ul class="threecol">
            <li class="active "><span class="design-icon"></span> <a href="sales-page-design.php">Design</a></li>
            <li><a href="sales-page-content.php"> Content </a></li>
        ...
        <div class="gray-grd gray-bdr graybox bdr-top-none p20 ">
          ...
          <div class="col175 ">
            <div class="f-left label lh-normal">
              ...
              Red</div>
            <div class="f-right">
              <a id="color_opt_red" href="images/salespage/men_women_red_large.jpg" title="Color Options Red"><img style="margin-left:-7px" src="images/buttons/see-example-btn.png"/></a>
            </div>
            <div class="row20"></div>
            <div class="picbg173"><img src="images/salespage/men_women_red_thumb.jpg" width="159" height="209"></div>
          </div>
          <div class="col30 "></div>
          <div class="col175 ">
            <div class="f-left label lh-normal">
              ...
              Blue</div>
            <div class="f-right">
              <a id="color_opt_blue" href="images/salespage/men_women_blue_large.jpg" title="Color Options Blue"><img style="margin-left:-7px" src="images/buttons/see-example-btn.png"/></a>
            </div>
            <div class="row20"></div>
            <div class="picbg173"><img src="images/salespage/men_women_blue_thumb.jpg" width="159" height="209"></div>
          </div>
          <div class="col30 "></div>
          <div class="col175 ">
            <div class="f-left label lh-normal">
              ...
              Purple</div>
            <div class="f-right">
                <a id="color_opt_purple" href="images/salespage/men_women_purple_large.jpg" title="Color Options Purple"><img style="margin-left:-7px" src="images/buttons/see-example-btn.png"/></a>
            </div>
            <div class="row20"></div>
            <div class="picbg173"><img src="images/salespage/men_women_purple_thumb.jpg" width="159" height="209"></div>
          </div>
          <div class="col30 "></div>
          <div class="col175 ">
            <div class="f-left label lh-normal">
              ...
              Black</div>
            <div class="f-right">              	   
			   <a id="color_opt_black" href="images/salespage/men_women_grey_large.jpg" title="Color Options Grey"><img style="margin-left:-7px" src="images/buttons/see-example-btn.png"/></a>
            </div>
            <div class="row20"></div>
            <div class="picbg173"><img src="images/salespage/men_women_grey_thumb.jpg" width="159" height="209"></div>
          </div>
        </div>
        <div class="gray-grd gray-bdr graybox mt20 nopad">
          <div class="gray-corner topLeft"></div>
        ...
        <div class="gray-grd gray-bdr graybox bdr-top-none p20 ">
          ...
          <div class="col240 ">
            <div class="f-left label lh-normal">
              ...
              Men</div>
            <div class="f-right">
              <?php /* <div class="see-example-btn" id="header_opt_men"></div>
			   <div id="header_optpopup_men" style=" min-width:360px; width: auto; min-height: 116.633px; height: auto; display:none"><img src="images/Watermarked/FWG-Blog-Page-Men.png" ></div>*/?>
          ...
          <div class="col240 ">
            <div class="f-left label lh-normal">
              ...
              Women</div>
            <div class="f-right">
              <?php /*<div class="see-example-btn" id="header_opt_women"></div>
			   <div id="header_optpopup_women" style=" min-width:360px; width: auto; min-height: 116.633px; height: auto; display:none"><img src="images/Watermarked/FWG-Blog-Page-Women.png"></div>*/?>
          ...
          <div class="col240 ">
            <div class="f-left label lh-normal">
              ...
              Men & Women</div>
            <div class="f-right">
              <?php /*<div class="see-example-btn" id="header_opt_men-women"></div>
			   <div id="header_optpopup_men-women" style=" min-width:360px; width: auto; min-height: 116.633px; height: auto; display:none"><img src="images/Watermarked/FWG-Blog-Page-Men&Women.png"></div>*/?>
        ...
        <div class="gray-grd gray-bdr graybox bdr-top-none p20 "> 
          ...
          <div class="col245 ">
            <div class="f-right">
              <?php /* <div class="see-example-btn" id="phone_number_opt3"></div>
			   <div id="phone_number_optpopup3" style="display:none"><img src="images/Watermarked/FWG-Blog-Page-Men&amp;Women.png">></div>*/?>
        ...
        <div class="gray-grd gray-bdr graybox bdr-top-none p20 ">
          ...
          <div class="col245 ">
            ...
            <div class="f-right">
              <?php /*<div class="see-example-btn" id="profile_number_opt"></div>
			   <div id="profile_number_optpopup" style="display:none"><img src="images/Watermarked/FWG-Blog-Page-Men.png"></div>
			   */?>
