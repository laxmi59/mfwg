...
if(isset($_REQUEST['act']) && isset($_REQUEST['id'])){
	...
	if($res[0]==1){
		Header("Location: sales-page-testimonials.php");
		exit;
	}
}
      ...
      <div id="primary" class="pd30">
        <div class="blue-grd blue-bdr tabs">
          ...
          <ul class="threecol">
            ...
            <li class="last active"><span class="bubble-icon"></span><a href="sales-page-testimonials.php"> Testimonials </a></li>
          </ul>
        </div>
            ...
            <div class="p27">
              <div class="tst"> 
				...
				foreach($getData as $data){?>
					...
					<div><a class="del-btn" href="sales-page-testimonials.php?act=del&id=<?php echo $data['id']?>" onclick = "if (! confirm('Are you sure you want to delete this Testimonial?')) return false;"> </a></div>
					</div> 
				<?php }
				}else{
        ...
        <div class="gray-grd gray-bdr graybox mt20 nopad">
          ...
          <div class="col560">
            <div class="p27">
              <div class="tst"> 
			   <?php 
			   $getData=$S->getAllTextTestimonials('2');
			   if($getData){
				foreach($getData as $data){?>
        ...
        <div class="prevbtn mt20 ml20 f-left" onClick="javascript:window.location='sales-page-content.php'"></div>        
